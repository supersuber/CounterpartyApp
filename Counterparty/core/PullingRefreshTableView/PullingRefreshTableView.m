...
//"Refresh"="Refresh...";
//"PullUpToGetMore"="Pull up to get more...";
//"LoosenToGetMore"="Loosen to get more...";
//"Updating"="Updating...";
//"LastUpdated"="Last updated";


#define kPullDownToRefresh	 @"下拉刷新..." //@"Pull down to refresh..."
#define kReleaseToRefresh    @"松开刷新" //@"Release to refresh..."
#define kRefresh             @"刷新" //@"Refresh..."

#define kPullUpToGetMore     @"上拉获取更多..." //@"Pull up to get more..."
#define kLoosenToGetMore     @"松开获取更多..." //@"Loosen to get more..."
#define kUpdating            @"更新..." //@"Updating..."
#define kLastUpdated         @"最后更新" //@"Last updated"
...
//        self.backgroundColor = [UIColor clearColor];
        ...
        _stateLabel.text = NSLocalizedString(@"PullDownToRefresh", @"");
//        _stateLabel.text = kPullDownToRefresh;
...
//    x = 0;
    ...
    if (self.isAtTop) {
        ...
        _arrow.contents = (id)arrow.CGImage;
        _stateLabel.text = NSLocalizedString(@"PullUpToGetMore", @"");
//        _stateLabel.text = kPullUpToGetMore;
    }
...
//                _stateLabel.text = kRefresh;
            } else {
                _stateLabel.text = NSLocalizedString(@"Updating", @"");
//                _stateLabel.text = kUpdating;
            }
            ...
            if (self.isAtTop) {
                _stateLabel.text = NSLocalizedString(@"ReleaseToRefresh", @"");
//                _stateLabel.text = kReleaseToRefresh;
            } else {
                _stateLabel.text = NSLocalizedString(@"LoosenToGetMore", @"");
//                _stateLabel.text = kLoosenToGetMore;
            }
...
//                _stateLabel.text = kPullUpToGetMore;
            ...
            if (!self.isAtTop) {    //footer
                _arrow.hidden = YES;
                _stateLabel.text = NSLocalizedString(@"AllContentHasBeenDisplayed", @"");
//                _stateLabel.text = NSLocalizedString(@"All content has been displayed", @"");
            }
        }
    }
}
...
- (void)updateRefreshDate :(NSDate *)date{
    ...
    /*
    [HXLoger log:@"dateString1=%@", dateString);    
    
//    NSString *title = NSLocalizedString(@"今天", nil);
    NSString *title = @"Today";
...
//            title = NSLocalizedString(@"前天",nil);
    ...
    [HXLoger log:@"dateString2=%@", dateString);
     */
    
    _dateLabel.text = [NSString stringWithFormat:@"%@: %@",
                       NSLocalizedString(@"LastUpdated", @""),
                       dateString];
